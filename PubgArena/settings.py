"""
Django settings for PubgArena project.
...
SECRET_KEY = '#7cw61vvoly*s)5k=tznv4ou_+-ri)uf3hx1$r+tg1!_(++hy^'
...
WSGI_APPLICATION = 'PubgArena.wsgi.application'
